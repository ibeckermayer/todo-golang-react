...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "g4ppsap6ygrgqpvjf3qkvg4mj6v85xc9vwjse7cruwkakme1hh2h",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Example Todo List App"),
...
const myCommand :Spk.Manifest.Command = (
  ...
  argv = ["/sandstorm-http-bridge", "5001", "--", "/bin/bash", "/opt/app/.sandstorm/launcher.sh"],
  environ = [
